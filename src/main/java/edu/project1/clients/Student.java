...
public class Student extends Client {
    ...
    public void discountSystem(Movie movie) {
        switch (movie.status_of_movie) {
            case PREMIERE:
                System.out.println("Discount for student " + getPrice(TypeOfPlace.NORMAL) * 0.83);
                break;
            case AVAILABLE:
                System.out.println("Discount for student " + getPrice(TypeOfPlace.NORMAL) * 0.75);
                break;
            default:
                System.out.println(" Not Discount for student " + getPrice(TypeOfPlace.NORMAL));
        }
    }
}